                ...
                return (
                  <div key={item.uid}>
                    <div className="flex items-center gap-3 px-6 py-3.5 hover:bg-gray-50">
                      <div className="min-w-0 flex-1">
                        <p className="text-sm font-semibold text-[#001489]">{fd.artist_name}</p>
                        ...
                        {GROUPS.map((group) => {
                          ...
                          return (
                            <div key={group} className="mb-3">
                              <p className="mb-1.5 text-[10px] font-bold uppercase tracking-wider text-[#001489]">{group}</p>
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {processItems.map((item) => (
                      <tr key={item.uid} className={item.status === "error" ? "opacity-60" : ""}>
                        ...
                        <td className="px-4 py-2.5 text-center font-bold text-[#001489]">
